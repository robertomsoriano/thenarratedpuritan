...
const HomeHero = () => {
    return (
        <div className={`d-flex align-items-center justify-content-center flex-column mt-5`} >
            ...
            <div className={`row flex-column align-items-center justify-content-center`} style={{ background: 'rgb(244,247,250)', width: '100%' }}>
                ...
                <div className={`col-sm-6 col-lg-6 mb-5`} style={{ minHeight: '50vh', }}>
